...
/**
 * Class that represents the Discrete Cosine Transform. Both compress and decompress.
...
public class DCT {
    ...
    /**
     * Apply the Discrete Cosine Transform on a 8x8 block in the spatial domain.
     * @param inBlock The 8x8 block to transform in the spatial domain.
     * @return The transformed block in the frequency domain.
     */
    ...
    /**
     * Apply the Inverse Discrete Cosine Transform on a 8x8 block from the frequency domain.
     * @param inBlock The 8x8 block to transform in the frequency domain.
     * @return The transformed block in the spatial domain.
     */
    ...
    /**
     * Compress an image with the Discrete Cosine Transform.
     * @param image The image to compress.
     * @return A byte array with the compressed image.
     */
    ...
    /**
     * Decompress an image with the Inverse Discrete Cosine Transform.
